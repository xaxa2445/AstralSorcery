...
import net.minecraft.resources.ResourceLocation; // Se mantiene, pero verifica el paquete
...
public enum Mods {
    ...
    /**
     * En 1.20.1, IForgeRegistryEntry fue eliminado.
     * Ahora usamos ResourceLocation para verificar la propiedad de un objeto.
     */
    public boolean owns(ResourceLocation registryName) {
        return this.isPresent() &&
                registryName != null &&
                registryName.getNamespace().equals(this.modid);
    }
