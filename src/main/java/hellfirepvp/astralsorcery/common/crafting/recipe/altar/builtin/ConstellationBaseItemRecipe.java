...
public class ConstellationBaseItemRecipe extends SimpleAltarRecipe {
    ...
    public static ConstellationBaseItemRecipe convertToThis(SimpleAltarRecipe other) {
        return new ConstellationBaseItemRecipe(other.getId(), other.getAltarType(), other.getDuration(), other.getStarlightRequirement(), other.getInputs());
    }
    ...
    public void deserializeAdditionalJson(JsonObject recipeObject) throws JsonSyntaxException {
        ...
        if (GsonHelper.isValidNode(recipeObject, KEY_CONSTELLATION)) {
            ResourceLocation cstName = new ResourceLocation(GsonHelper.getAsString(recipeObject, KEY_CONSTELLATION));
