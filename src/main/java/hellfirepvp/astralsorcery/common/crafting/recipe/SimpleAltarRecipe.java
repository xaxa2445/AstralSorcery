...
public class SimpleAltarRecipe extends CustomMatcherRecipe implements GatedRecipe.Progression {
    ...
    // 4. EL CONSTRUCTOR MAESTRO (El que realmente inicializa todo)
    ...
    @Override
    public RecipeType<?> getType() { // Antes era IRecipeType
