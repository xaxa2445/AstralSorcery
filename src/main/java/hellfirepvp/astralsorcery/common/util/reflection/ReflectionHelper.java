...
public class ReflectionHelper {
    ...
    private static BiConsumer<ItemEntity, Integer> itemEntityAgeSetter;
    private static BiConsumer<ItemEntity, Float> itemEntityBobOffsSetter;
    ...
    public static void setItemAge(ItemEntity entity, int age) {
        if (itemEntityAgeSetter == null) {
            // "age" es el nombre del campo en la clase ItemEntity que me mostraste
            itemEntityAgeSetter = getFieldSetter(ItemEntity.class, "age", Field::setInt);
        }
        itemEntityAgeSetter.accept(entity, age);
    }

    public static void setItemBobOffs(ItemEntity entity, float bobOffs) {
        if (itemEntityBobOffsSetter == null) {
            itemEntityBobOffsSetter = getFieldSetter(ItemEntity.class, "bobOffs", Field::setFloat);
        }
        itemEntityBobOffsSetter.accept(entity, bobOffs);
    }
