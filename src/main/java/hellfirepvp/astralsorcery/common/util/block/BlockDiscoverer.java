...
import net.minecraft.core.Direction; // Cambio de paquete
import net.minecraft.util.Mth; // MathHelper -> Mth (Nombres abreviados de Mojang)
import net.minecraft.world.level.Level;
import net.minecraft.world.level.block.entity.BlockEntity; // TileEntity -> BlockEntity
import net.minecraft.world.level.block.state.BlockState; // Cambio de paquete
                ...
                if (ch != null) {
                    out.addAll(
                            ch.getBlockEntities()
                                    .values()
                                    .stream()
                                    .filter(tile -> tile.getBlockPos().closerThan(origin, distance))
                                    .filter(match)
