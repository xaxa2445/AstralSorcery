...
import net.minecraft.world.level.material.Fluid; // Paquetes actualizados
...
public class SimpleSingleFluidTank implements IFluidTank {
    ...
    public CompoundTag writeNBT() {
        ...
        ResourceLocation fluidId = ForgeRegistries.FLUIDS.getKey(this.fluid);
        tag.putString("fluid", fluidId != null ? fluidId.toString() : "minecraft:empty");
        return tag;
    }
