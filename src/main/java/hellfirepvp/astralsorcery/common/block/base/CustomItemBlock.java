...
import net.minecraft.world.level.block.Block; // net.minecraft.block -> net.minecraft.world.level.block
import net.minecraft.world.item.BlockItem;    // net.minecraft.item -> net.minecraft.world.item
