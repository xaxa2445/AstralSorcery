...
import net.minecraft.world.entity.Entity; // net.minecraft.entity -> net.minecraft.world.entity
import net.minecraft.util.Mth; // MathHelper -> Mth
import org.joml.Matrix4f; // util.math.vector.Matrix4f -> org.joml.Matrix4f
