...
public class TextureSubQuery extends TextureQuery {
    ...
    public AbstractRenderableTexture resolve() {
        ...
        return new AbstractRenderableTexture(res.getKey()) {
            ...
            // Implementación de offsets individuales para evitar el uso de Tuple
            @Override
            ...
            public boolean equals(Object obj) {
                if (obj instanceof AbstractRenderableTexture other) {
                    return res.getKey().equals(other.getKey());
                }
                return false;
            }
